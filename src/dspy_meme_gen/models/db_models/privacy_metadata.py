...
class PrivacyMemeMetadata(Base):
    ...
    audit_logs = relationship(
        "PrivacyAuditLog", back_populates="meme", cascade="all, delete-orphan"
    )
...
class UserConsent(Base):
    ...
    __table_args__ = (UniqueConstraint("user_pseudonym", "consent_type"),)
...
class AnonymizedAnalytics(Base):
    ...
    __table_args__ = (Index("idx_analytics_date_type", "date", "metric_type"),)
