...
class MemeGeneratorActor(Actor):
    ...
    def __init__(
        ...
        self.image_gen_breaker = CircuitBreaker(
            "image_generation", 
            CircuitBreakerConfig(failure_threshold=2, timeout=60)
        )
    ...
    async def handle_generatememerequest(self, message: GenerateMemeRequest) -> Dict[str, Any]:
        ...
        try:
            ...
            # Refine if needed
            while (self.current_meme_data["score"] < message.target_score and 
                   self.refinement_count < message.max_refinements):
    ...
    async def _generate_image(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "image_url": f"https://placeholder.pics/svg/600x600/FF0000/FFFFFF/Error"
            }
