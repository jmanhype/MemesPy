...
def add_timestamp(_: logging.Logger, __: str, event_dict: EventDict) -> EventDict:
...
def add_caller_info(_: logging.Logger, __: str, event_dict: EventDict) -> EventDict:
    ...
    while frame:
        ...
        if module.startswith("dspy_meme_gen"):
            event_dict.update(
                {"module": module, "function": frame.f_code.co_name, "line": frame.f_lineno}
            )
            break
        frame = frame.f_back
    return event_dict
...
def log_function_call(func: F) -> F:
    ...
    async def async_wrapper(*args: Any, **kwargs: Any) -> Any:
        ...
        try:
            ...
            logger.info("function_return", function=func.__name__, result=str(result))
            return result
...
def log_performance(func: F) -> F:
    ...
    async def async_wrapper(*args: Any, **kwargs: Any) -> Any:
        ...
        try:
            ...
            logger.info("function_performance", function=func.__name__, duration_seconds=duration)
            return result
        except Exception as e:
            duration = (datetime.now() - start_time).total_seconds()
            logger.error(
