...
def sample_route_result() -> Dict[str, Any]:
    ...
    return {
        ...
        "format": "Drake",
        "verification_needs": {"factuality": False, "appropriateness": True},
...
def test_router_forward_success(
    mocker: MockerFixture, sample_user_request: str, sample_route_result: Dict[str, Any]
) -> None:
    """
    ...
    mock_predictor.verification_needs = {"factuality": False, "appropriateness": True}
...
def test_router_format_detection(
    mocker: MockerFixture, request_text: str, expected_format: str
) -> None:
    """
