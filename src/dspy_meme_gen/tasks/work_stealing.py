...
class WorkStealingScheduler:
    ...
    def __init__(self, num_workers: int = None):
        ...
        """
        self.num_workers = num_workers or asyncio.get_event_loop()._thread_pool_executor._max_workers
        
        # Create work queues for each worker
        self._work_queues: List[WorkQueue] = [
            WorkQueue(i) for i in range(self.num_workers)
        ]
