...
def test_scoring_memes(
    ...
    mock_meme_candidates: List[Dict[str, Any]]
) -> None:
...
def test_scoring_with_appropriateness_check(
    ...
    scored_memes = scoring_agent.forward(mock_meme_candidates, appropriateness_check=appropriateness_check)
...
def test_memes_sorted_by_score(
    scoring_agent: ScoringAgent,
