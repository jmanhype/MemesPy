...
class AsyncEventSourcedSystem:
    ...
    async def _spawn_core_actors(self) -> None:
        ...
        image_actor = ImageGeneratorActor(
            name="image_generator", openai_api_key=settings.openai_api_key
        )
        ...
        try:
            ...
            scorer_actor = QualityScorerActor(name="quality_scorer", model_name=settings.dspy_model)
        ...
        try:
            ...
            verifier_actor = VerifierActor(name="verifier", model_name=settings.dspy_model)
