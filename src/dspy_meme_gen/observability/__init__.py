...
try:
    ...
    def record_meme_generation_metric(*args, **kwargs):
        pass

    def record_generation_time(*args, **kwargs):
        pass

    def record_error_metric(*args, **kwargs):
        pass
...
try:
    ...
    def trace_meme_generation(*args, **kwargs):
        pass

    def trace_verification(*args, **kwargs):
        pass

    def trace_scoring(*args, **kwargs):
        pass


try:
    from .telemetry import initialize_telemetry, shutdown_telemetry, TelemetryConfig
...
try:
    from .spans import SpanContext, create_child_span, add_span_attributes, set_span_status
except ImportError:
