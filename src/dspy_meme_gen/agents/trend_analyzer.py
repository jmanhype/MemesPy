...
class TrendTopic(dspy.Signature):
    ...
    topics: List[Dict[str, Any]] = dspy.OutputField(description="List of trending topics with details")
...
class TrendAnalyzer:
    ...
    async def get_trending_topics(self, query: Optional[str] = "current internet meme trends") -> List[Dict[str, Any]]:
        """
