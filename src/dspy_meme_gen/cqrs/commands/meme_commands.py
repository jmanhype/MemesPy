...
from ..events import (
    MemeGenerationRequested, MemeGenerated, MemeGenerationFailed,
    MemeScored, MemeRefined, MemeApproved, MemeRejected, MemeDeleted
)
        ...
        try:
            ...
            try:
                ...
                return CommandResult.success(
                    value=aggregate.id,
                    events=[request_event, success_event]
                )
