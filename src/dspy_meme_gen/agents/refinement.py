...
class RefinementLoopAgent(dspy.Module):
    ...
    def forward(
        ...
        try:
            ...
            # Get initial score
            initial_score = self._score_meme(
                meme,
                factuality_check,
            ...
            for iteration in range(self.config.max_iterations):
                ...
                improvements = self.improvement_planner(
                    scores=initial_score["component_scores"],
                    feedback=initial_score["feedback"]
                )
