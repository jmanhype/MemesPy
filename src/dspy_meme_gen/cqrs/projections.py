...
from .events import DomainEvent, MemeGenerationStarted, TextGenerated, ImageGenerated, QualityScored, MemeCompleted, MemeGenerationFailed, MemeViewed, MemeShared, VerificationCompleted, PipelineStageStarted, PipelineStageCompleted
        ...
        async with self._locks[f"metrics_{date_key}"]:
            ...
            for key, value in updates.items():
                if hasattr(metrics, key):
                    if key in ['total_requests', 'successful_generations', 'failed_generations', 'completed_pipelines']:
