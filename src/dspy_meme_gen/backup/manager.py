...
class BackupManager:
    ...
    def __init__(self, config: Dict[str, Dict[str, Union[str, int]]], db_url: str) -> None:
    ...
    async def _upload_to_s3(self, local_path: str, bucket: str, s3_path: str) -> None:
        ...
        """
        try:
            await asyncio.to_thread(self.s3_client.upload_file, local_path, bucket, s3_path)
    ...
    async def _download_from_s3(self, bucket: str, s3_path: str, local_path: str) -> None:
        ...
        """
        try:
            await asyncio.to_thread(self.s3_client.download_file, bucket, s3_path, local_path)
        except BotoCoreError as e:
