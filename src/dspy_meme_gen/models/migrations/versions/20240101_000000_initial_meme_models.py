...
def upgrade() -> None:
    ...
    # Create indexes
    op.create_index(op.f('ix_meme_templates_format_type'), 'meme_templates', ['format_type'], unique=False)
    op.create_index(op.f('ix_generated_memes_template_id'), 'generated_memes', ['template_id'], unique=False)
    op.create_index(op.f('ix_trending_topics_topic'), 'trending_topics', ['topic'], unique=False)
    op.create_index(op.f('ix_trending_topics_timestamp'), 'trending_topics', ['timestamp'], unique=False)
