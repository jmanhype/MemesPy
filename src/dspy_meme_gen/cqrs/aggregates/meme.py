...
class MemeAggregate:
    ...
    def to_snapshot(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "generated_at": (
                self.state.generated_at.isoformat() if self.state.generated_at else None
            ),
    ...
    def from_snapshot(self, snapshot: Dict[str, Any], version: int) -> None:
        ...
        self.state = MemeState(
            ...
            scored_at=(
                datetime.fromisoformat(snapshot["scored_at"]) if snapshot.get("scored_at") else None
            ),
            approved_at=(
            ...
            rejected_at=(
                datetime.fromisoformat(snapshot["rejected_at"])
                if snapshot.get("rejected_at")
                else None
            ),
            deleted_at=(
                datetime.fromisoformat(snapshot["deleted_at"])
